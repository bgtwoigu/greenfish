...
function pcxLoadFromStream(bm: TBitmap32; s: TStream): boolean;
function pcxSaveToStream(bm: TBitmap32; s: TStream): boolean;
...
begin
  Result := (Size >= 3) and
    (PByteArray(Data)[0] = PCX_MANUFACTURER) and
    (PByteArray(Data)[2] = PCX_ENCODING_RLE);
end;
