...
type
  ...
  public
    ...
    constructor Create(Data: PIntegerArray; DataCount: integer); virtual; overload;
...
constructor TiePalette.Create(Data: PIntegerArray; DataCount: integer);
var
  i: integer;
...
initialization
  ...
  palWin16 := TiePalette.Create(@palWin16_Data, 16);
  palMac16 := TiePalette.Create(@palMac16_Data, 16);
  palMac256 := TiePalette.Create(@palMac256_Data, 256);
finalization
  palBW.Free;
  palWin16.Free;
  palMac16.Free;
