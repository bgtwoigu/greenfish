...
begin
  ...
  rClip.Right := Min(rClip.Left + Dest.Width, Src.Width, rClip.Right);
  rClip.Bottom := Min(rClip.Top + Dest.Height, Src.Height, rClip.Bottom);
...
begin
  ...
  xMin := Max(0, r.Left); xMax := Min(Src.Width, Dest.Width, r.Right) - 1;
  for y := Max(0, r.Top) to Min(Src.Height, Dest.Height, r.Bottom) - 1 do
  begin
