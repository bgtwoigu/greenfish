...
function Min(a, b, c: integer): integer; inline; overload;
function Min(a, b, c, d: integer): integer; inline; overload;
function Min(a, b, c, d: double): double; inline; overload;
function Max(a, b, c: integer): integer; inline; overload;
function Max(a, b, c, d: integer): integer; inline; overload;
function Max(a, b, c, d: double): double; inline; overload;
...
function Max(a, b, c, d: double): double;
begin
  Result := Max(Max(a, b), Max(c, d));
end;
